 ...
 async function formSubmission(submission){
  ...
  try{
   ...
   await sendEmail({
    ...
    html:'<!doctype html><html><body style="margin:0;padding:0;background:#ffffff;"><div style="max-width:640px;margin:0 auto;padding:32px 24px;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:1.6;color:#111827;"><p style="margin:0 0 24px;">'+greeting+'</p><p style="margin:0 0 24px;">Thank you for requesting a Ready for Real Life Safety review. Your request has been received.</p><p style="margin:0 0 24px;">I will personally review the information you submitted and follow up with you regarding next steps. If the review appears to be a good fit for your organization, I will send you a secure link to complete the $499 Founding Client payment and begin the review process.</p><p style="margin:0 0 24px;">No payment has been collected at this point.</p><p style="margin:0 0 28px;">Please avoid sending sensitive operational information by email.</p><p style="margin:0;">Mike<br>Ready for Real Life Safety</p></div></body></html>'
   });
